    ...
    return (
        <div className="flex flex-col h-full">
            <div className="basis-[15%]">
                ...
                <div class="relative">
                    <input className="m-4 w-[33.4375rem] h-[3.375rem] border-[#827F7F82] rounded-md focus:outline-none focus:ring focus:ring-[#02685A] focus:ring-opacity-70" type="text" placeholder="Search Patients" name="" id="" />
...
<div class="relative m-4 overflow-x-auto shadow-md sm:rounded-lg">
    <table class="w-full text-sm text-left rtl:text-right text-gray-500">
        <thead class="text-xs text-gray-700 uppercase h-[4.5rem] bg-gray-50 bg-[#F5F6F8] text-[#7B7878]">
