    ...
    <div className='flex flex-col'>
      ...
      <div className=''>
        <div className='flex mt-6 mb-8  justify-center'>
          <div className='h-10 text-sm justify-center w-80 flex items-center border border-[#7B7878] rounded-l-sm bg-white cursor-pointer'>
            Import Records
          </div>
          <div className='h-10 text-sm justify-center w-80 flex items-center text-white bg-[#006666] cursor-pointer'>
            Add Records
          </div>
          <div className='h-10 text-sm justify-center w-80 flex items-center border border-[#7B7878] bg-white rounded-r-sm cursor-pointer'>
            Billing
          </div>
        </div>

        <div className='border mx-7 my-2 border-[#006666] rounded-md border-l-4'>
