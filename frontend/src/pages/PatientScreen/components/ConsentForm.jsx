...
const ConsentForm = () => {
  return (
    <div className="border mx-3 my-4 border-[#006666] rounded-md border-l-4 overflow-hidden">
      <p className="font-semibold text-2xl ml-4 mt-4 mb-4 text-[#444444]">
      ...
      <div className="flex ml-6 mr-6 mb-6 justify-center">
        <div className="h-10 text-sm w-1/2 flex items-center  p-4 bg-white rounded">
          <div className="h-10 text-sm w-2/3 flex items-center border bg-white rounded"></div>
        ...
        <div className="h-10 text-sm w-1/2 flex items-center  ml-4 p-4 bg-white rounded-lg">
          <div className="h-10 text-sm w-full flex items-center border mr-2 p-2 bg-white rounded-lg"></div>
          -
          <div className="h-10 text-sm w-full flex items-center border ml-2 mr-2 p-4 bg-white rounded-lg"></div>
          -
          <div className="h-10 text-sm w-full flex items-center border ml-2 mr-2 p-4 bg-white rounded-lg"></div>
          -
          <div className="h-10 text-sm w-full flex items-center border ml-2 mr-2 p-4 bg-white rounded-lg"></div>
      ...
      <div className="flex mt-6 ml-6 mr-6 justify-center">
        ...
        <div className="h-10 text-sm w-1/3 flex items-center p-4 bg-white"></div>
      </div>
      <div className="flex ml-6 mr-6 mb-6 justify-center">
        <div className="h-10 text-sm w-full flex items-center border p-4 ml-4 mr-7 bg-white rounded"></div>
        <div className="h-10 text-sm w-full flex items-center border p-4 ml-4 mr-7 bg-white rounded"></div>
        <div className="h-10 text-sm w-full flex items-center p-4 ml-4 mr-7 bg-white"></div>
      </div>
      ...
      <div className="flex mt-6 ml-6 mr-6 justify-center">
        ...
        <div className="h-10 text-lg w-full flex items-center p-4 bg-white"></div>
      </div>
      <div className="flex ml-6 mr-6 mb-6 justify-center">
        <div className="h-10 text-sm w-full flex items-center border p-4 ml-4 mr-7 bg-white rounded"></div>
        <div className="h-10 text-sm w-full flex items-center border p-4 ml-4 mr-7 bg-white rounded"></div>
      ...
      <div className="flex mt-6 ml-6 mr-6 justify-center">
        <div className="h-10 text-lg w-1/3 flex items-center p-4 bg-white"></div>
        <div className="h-10 text-lg w-1/3 flex items-center p-4 bg-white"></div>
