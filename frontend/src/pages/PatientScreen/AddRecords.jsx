  ...
  return (
        <div className='flex flex-col'>
            ...
            <div className=''>
              ...
              <div className="border mx-8 my-2 border-[#006666] rounded-md border-l-4">
                <div className=" m-s:max-h-[350px] lg:max-h-[420px] 2xl:max-h-[470px] 4xl:max-h-[850px] flex flex-col overflow-auto">
                  <div className=''>
