          ...
          <div className='bg-white pl-[25%] w-[60%] flex-col'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <input
                ...
                className='w-[100%] mr-[10px] rounded-[5px] mb-[5px]' {...register("username",{required: true,})}
              />
              ...
              <input
                type='password'
                className='w-[100%] mr-[10px] rounded-[5px] mb-[5px]' {...register("password",{required: true,})}
              />
              ...
              <div className="persistCheck m-[5px]">
                    <input
                        ...
                        checked={persist}
                    />
                    <span className='text-[#7F8C8D] ml-[5px] pb-[10px]'>Remember Me</span>
                </div>
            <a href={''} className='text-[#308EDC]'>
              Forget Password?
            </a>
            <button className='mt-[20px] bg-[#02685A] border-0 rounded-[5px] w-[100%] text-white p-[10px]' type="submit">
              LOGIN
            </button>
            </form>
          </div>
